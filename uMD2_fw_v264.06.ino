...
#if Interpolation == 1
#define Samples_to_Average 1       // Number of averages.  The maximum is around 4 with 5,000 samples; 12 with 500 samples.  Try not to go close to or over PRC 97% as bad things msy happen. ;( ;-) 
...
#if Interpolation == 0
#define Samples_to_Average 1000    // Number of averages.  The maximum is over 1,000.  The Samples_to_Capture value doesn't matter.
...
#define FirmwareSubVersion 06   // Now numeric in XXX.YY format.
...
void setup() {
  ...
  Number_Averaging_Samples = Samples_to_Average;
  Fraction_Averaging_Samples = (Samples_to_Average - 1.0) / Samples_to_Average;
  One_Over_Averaging_Samples = 1.0 / Samples_to_Average;
}
