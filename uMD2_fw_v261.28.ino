...
#define FirmwareSubVersion 28   // Now numeric in XXX.YY format.
...
#define Old_uMD_GUI 0           // Set to 1 for 8 bit interpolation with pre-2025 GUI or if 2025+ GUI is used.

// No user or hacker sericeable parts beyond this point. ;-)

#define Phase_8bit_Flag 2       // Set to 2 to tell the 2025+ GUI to use 8 bit Phase values.
#define FirmwareVersion_Flag 4  // Set to 4 to tell the 2025+ GUI to use the new firmware Version/Subversion format for About.
...
#if (Phase_8bit_Flag == 1) || (Old_uMD_GUI == 1)  // Use 8 bit Phase if it is selected or old uMD GUI
