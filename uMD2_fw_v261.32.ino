...
#define FirmwareSubVersion 32   // Now numeric in XXX.YY format.
...
void Interpolation_Execute() {
  ...
  if (No_REF != 0x12345) { // REF OK)
    ...
    if ((abs(displacement1 - previous_displacement1) <= 1) && (Phase_State1 != Error_State_15)) {
      ...
      Set_Interpolation_Flags(displacement1, previous_displacement1, Phase1, Previous_Phase1);
    ...
    if ((abs(displacement2 - previous_displacement2) <= 1) && (Phase_State2 != Error_State_15)) {
      ...
      Set_Interpolation_Flags(displacement2, previous_displacement2, Phase2, Previous_Phase2);
    ...
    if ((abs(displacement3 - previous_displacement3) <= 1) && (Phase_State3 != Error_State_15)) {
      ...
      Set_Interpolation_Flags(displacement3, previous_displacement3, Phase3, Previous_Phase3);
...
void Set_Interpolation_Flags(int displacement, int previous_displacement, int phase, int previous_phase) {
